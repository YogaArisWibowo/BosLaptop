...
<body>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="action-btns" style="display: flex; gap: 5px;">
                                    ...
                                    <form action="{{ route('produk.hapus', $item->id_produk) }}" method="POST" onsubmit="return confirm('Yakin ingin menghapus produk ini?');">
                                        @csrf
                                        @method('DELETE')
    ...
    <div class="modal" id="addProductModal">
        <div class="modal-content">
            ...
            <form action="{{ route('produk.tambah') }}" method="POST" enctype="multipart/form-data" class="modal-form">
                @csrf
    ...
    <script>
        ...
        function openEditModal(button) {
            ...
            document.getElementById('formEditProduk').action = `/produkpemilik/edit/${id}`;
